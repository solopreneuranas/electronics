...
export default function ProductsSlider(props) {
    ...
    const bannerCarousel = () => {
        return products.slice(0, 18).map((item, i) => {
            ...
            return (
                <div key={i}>
                    <div onClick={() => handleProductClick(item)} style={{ background: '#121212', cursor: 'pointer', borderRadius: 15, padding: '8% 5% 4%', margin: '12px', height: matches_md ? '100%' : 500, position: 'relative' }}>
